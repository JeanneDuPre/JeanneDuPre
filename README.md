...
| Automate Application for Substitute Teacher Position at the schools in Berlin | <a href="">`code`</a> | `website`| Python Programming (Intermediate Level) |
...
| When is it worth swapping my old petrol car (BMW) for an electric car?| `code`| `website`|Scraping www.12gebrauchtwagen.de (petrol (BMW), electric, hybrid (BMW), electric, hybrid (cars)<br>Scraping gasoline price (E10) and electricity price<br>from 10.09.2023 until 10.10.2023<br>GitHub Actions<br>MongoDB|
